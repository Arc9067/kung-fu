    ...
    <section className="py-[50px] w-full bg-black">
      <div className="container">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-x-20 mt-16 gap-y-10">
          <div
            className="h-[400px]  rounded-lg bg-primary/60 flex relative flex-col justify-between"
            data-aos="fade-right"
          ...
          <div
            className="h-[400px]  rounded-lg bg-black border ring-1 ring-primary flex relative flex-col justify-between"
            data-aos="fade-left"
            data-aos-duration="500"
          >
            <div className="">
