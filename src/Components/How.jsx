  ...
  return (
    <section className="w-full bg-primary py-[50px]" id="ape">
      <div className="container">
        <h1 className="text-5xl md:text-7xl text-center shad2">how to ape </h1>

        <div className="flex flex-wrap gap-10 w-full justify-between items-center mt-10">
          <div className="min-h-[150px] gap-5 p-3 w-full lg:w-5/12 bg-primary/50 rounded-xl flex justify-between items-center">
